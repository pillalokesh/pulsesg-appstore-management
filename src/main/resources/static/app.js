...
function renderCards() {
    ...
    elements.selectionSummary.textContent = state.search || state.category !== "All applications"
    ...
    elements.appGrid.innerHTML = state.visibleApps.map((app) => `
        <article class="app-card">
            <div class="app-card-top">
                ...
                ${app.status ? `<span class="status-badge">${escapeHtml(app.status)}</span>` : ""}
            </div>
            ...
            <div class="card-actions">
                ...
                ${app.link ? `<a class="button button-link" href="${escapeHtml(app.link)}" target="_blank" rel="noopener">Open</a>` : `<span class="button button-link disabled">No link</span>`}
            </div>
        </article>
    `).join("");
}
...
function openDetails(appId) {
    ...
    elements.detailsContent.innerHTML = `
        ...
        <div class="details-body">
            ...
            ${app.link ? `<a class="button button-link" href="${escapeHtml(app.link)}" target="_blank" rel="noopener">Open application</a>` : `<span class="button button-link disabled">No launch link available</span>`}
        </div>
    `;
